        ...
        <div className='hero my-8'>
            <div className='hero-content flex flex-col gap-8 md:gap-16'>
                ...
                <div className="flex gap-8">
                    <div onClick={reset} className={`${!branch?.project?.task && "btn-disabled"} btn-lg btn btn-primary btn-outline p-4`}><svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18.364 18.364C19.9926 16.7353 21 14.4853 21 12C21 7.02944 16.9706 3 12 3C9.51472 3 7.26472 4.00736 5.63604 5.63604M18.364 18.364C16.7353 19.9926 14.4853 21 12 21C7.02944 21 3 16.9706 3 12C3 9.51472 4.00736 7.26472 5.63604 5.63604M18.364 18.364L5.63604 5.63604" stroke="#000000" className="stroke-current" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></div>
                    <div onClick={isRunning ? pause_timer : start_timer} className={`${!branch?.project?.task && "btn-disabled cursor-not-allowed"} btn-lg btn btn-primary btn-outline p-4`}>
                        {
                            isRunning 
                                ? 
                    ...
                    <div onClick={stop} className={`${!branch?.project?.task && "btn-disabled"} btn-lg btn btn-primary btn-outline p-4`}><svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect x="4" y="4" width="16" height="16" rx="2" className="stroke-current fill-current" stroke="#161212" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></rect> </g></svg></div>
                </div>
            </div>
        </div>
    )
